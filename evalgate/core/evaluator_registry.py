...
SPECS = (
    ...
    EvaluatorSpec("anomaly_logic_probe_v1", "2.0.0", "ai_quality", "evalgate.gates.gate1_ai_quality.anomaly_logic_probe", CI_PLUS, required_artifacts=("anomaly-report",)),
    EvaluatorSpec("sql_compilation_probe_v1", "2.0.0", "ai_quality", "evalgate.gates.gate1_ai_quality.sql_compilation_probe", CI_PLUS, required_artifacts=("proposals",)),
    EvaluatorSpec("profile_accuracy_probe_v1", "2.0.0", "input_data", "evalgate.gates.gate4_input_data.profile_accuracy_probe", CI_PLUS, required_artifacts=("dataset-profile", "input-dataset")),
    EvaluatorSpec("report_grounding_probe_v1", "2.0.0", "ai_quality", "evalgate.gates.gate1_ai_quality.report_grounding_probe", CI_PLUS, required_artifacts=("anomaly-report", "execution-results")),

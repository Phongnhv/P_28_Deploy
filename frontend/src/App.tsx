        ...
        <div className="page-container">
          ...
          {view === "workflow" && (
            <WorkflowPage
              ...
              onBackToDatasets={() => setView("datasets")}
            />
          )}
          {view === "datasets" && (
            <DatasetsPage

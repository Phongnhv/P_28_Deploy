        ...
        >
          <div className="results-score-grid" style={{ display: "grid", gridTemplateColumns: "minmax(320px, 1.2fr) 2fr", gap: "32px", alignItems: "center" }}>
            ...
            <div className="results-kpi-quad" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "14px" }}>
              ...
              <div className="results-kpi-box" style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", padding: "14px 16px", display: "flex", flexDirection: "column", gap: "6px", boxShadow: "0 1px 4px rgba(0,0,0,0.03)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span className="eyebrow" style={{ fontSize: "11px" }}>{isVi ? "BẢN GHI ĐÃ QUÉT" : "ROWS AUDITED"}</span>
                ...
                <small className="muted" style={{ fontSize: "11.5px", lineHeight: "1.4" }}>
                  {totalRowsFailed > 0
                    ...
                    : isVi ? "0 bản ghi vi phạm dữ liệu" : "0 invalid rows"}
                </small>
              </div>
              ...
              <div className="results-kpi-box" style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", padding: "14px 16px", display: "flex", flexDirection: "column", gap: "6px", boxShadow: "0 1px 4px rgba(0,0,0,0.03)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span className="eyebrow" style={{ fontSize: "11px" }}>{isVi ? "BẤT THƯỜNG PHÁT HIỆN" : "ANOMALIES FLAGGED"}</span>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={dqAnomalies.length > 0 ? "#f59e0b" : "#10b981"} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
                  </svg>
                </div>
                <div className="results-kpi-val" style={{ display: "flex", alignItems: "baseline", gap: "6px" }}>
                  <strong style={{ fontSize: "22px", fontWeight: 800, color: dqAnomalies.length > 0 ? "#f59e0b" : "#10b981" }}>
                    {dqAnomalies.length}
                  </strong>
                  <span className="results-kpi-sub" style={{ fontSize: "12px", color: "var(--muted)", fontWeight: 600 }}>
                ...
                <small className="muted" style={{ fontSize: "11.5px", lineHeight: "1.4" }}>
                  {dqAnomalies.length > 0
                    ...
                    : isVi ? "Không phát hiện đột biến bất thường" : "No anomalies detected"}
                </small>
              </div>
              ...
              <div className="results-kpi-box" style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", padding: "14px 16px", display: "flex", flexDirection: "column", gap: "6px", boxShadow: "0 1px 4px rgba(0,0,0,0.03)" }}>
                ...
                <small className="muted" style={{ fontSize: "11.5px", lineHeight: "1.4" }}>
                  {workflowNodeRuns.length > 0
                    ? isVi ? `${workflowNodeRuns.length} node agent qua 4 graph` : `${workflowNodeRuns.length} agent nodes executed`
                      ...
                      <div>
                        ...
                        <p className="muted" style={{ margin: "4px 0 0 0", fontSize: "13px", lineHeight: "1.5" }}>
                          {isVi
                            ...
                            : `${totalRowsFailed.toLocaleString()} records violated business assertions. Review source transformations or calibrate threshold parameters in Step 3.`}
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", flex: 1, minWidth: "280px" }}>
                      ...
                      <div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                          <strong style={{ fontSize: "14.5px" }}>
                            {isVi ? `Xem xét ${dqAnomalies.length} tín hiệu bất thường từ Graph 3` : `Investigate ${dqAnomalies.length} anomaly signals from Graph 3`}
                          </strong>
